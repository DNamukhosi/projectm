...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Approved Visitors</a></li>
        <li class="active">Approved Visitors - List</li>
      </ol>
    </section>
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">APPROVED VISITORS</h3>
      </div>
         <div class="box-header">
          
         <a href="pdfv1.php"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Print </span></a>
</div>
      <div class="modal fade" id="myModal" role="dialog">
       <div class="modal-dialog">
        <div class="modal-content">
          ...
          <h4 class="modal-title"> View Visitor</h4>
          </div>
