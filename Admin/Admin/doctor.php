     ...
     if($nrows==null)
      {
        $write =$conn->query("INSERT INTO sys_user(`user_id`,`username`,`password`,`level`) VALUES ('$dno','$username','$password','$id')") or die(mysqli_error());
            ...
            $writex =$conn->query("INSERT INTO doctors(`d_id`,`firstname`,`middlename`,`lastname`,`username`,`phone`,`idno`,`password`,`gender`,`specialization`) VALUES ('$dno','$fname','$mname','$lname','$username','$phone','$idno','$password','$gender','$categ')") or die(mysqli_error());
  ...
  <div class="col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">DOCTORS</h3>
      </div>
         <div class="box-header">
           <button type="button" class="popup" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus-square"></i> Add New</button>
       <a href="pdfd.php"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Print </span></a>
</div>
          ...
          <div class="modal-body">
            <form method="POST" enctype="multipart/form-data">
              ...
              <select name = "categ" class = "form-control" required = "required">
                ...
                <option value = "Phathologist">Phathologist</option>
              </select>
            </div>
              <div class="form-group">
...
<td>
<a href="infod.php?id=<?php echo $row['d_id']; ?>"><span class="btn btn-success bg-orange"><i class="fa fa-info"></i> Info </span></a>
<a href="editdoctor.php?id=<?php echo $row['d_id']; ?>"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Edit </span></a>
<a href="delete.php?id=<?php echo $row['d_id']; ?>"><span class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete </span></a>
