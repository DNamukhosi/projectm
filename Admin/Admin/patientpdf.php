...
<button><a style = "text-decoration:none; color:#000;" href = "patients.php">Back</a></button>
<?php
    $_SESSION['date'] = date("d-m-Y");
   include("../../inc/connect.php") ;
    $query = $conn->query("SELECT p_appointments.p_id,p_appointments.name,patients.gender,patients.phone_no,patients.idno,patients.dob,p_appointments.date,patients.physical_location as address FROM p_appointments left join patients on p_appointments.p_id=patients.p_id order by p_appointments.p_id") or die(mysqli_error());
    $f = $query->fetch_array();
?>
    ...
    <div id="print">
        <div style = "margin:10px;">    <br />      
            ...
            <center>
                <table>
                        <tr>
                            <th style = "padding-right:20px;padding-left:20px;"><center>Pat. No.</center></th>
                            ...
                            <th style = "padding-right:30px;padding-left:30px;"><center>Address</center></th>
                            <th style = "padding-left:20px; padding-right:20px;"><center>Phone</center></th>
                            <th style = "padding-left:20px; padding-right:20px;"><center>IDNO</center></th>
                            <th style = "padding-left:20px; padding-right:20px;"><center>Date</center></th>
                        </tr>
                <?php
