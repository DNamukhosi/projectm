...
<body> 
<button onclick="printContent('pdfb')">Print Content</button>
<button><a style = "text-decoration:none; color:#000;" href = "manage-beds.php">Back</a></button>
<?php
            ...
            <center>
                <table>
                        <tr>
                            ...
                            <th style = "padding-right:60px;padding-left:60px;"><center>Bed</center></th>
                            <th style = "padding-right:60px;padding-left:60px;"><center>Ward</center></th>
                            <th style = "padding-left:20px; padding-right:20px;"><center>Occupied</center>
                            </th>
                        </tr>
                <?php
        ...
        $cnt=$query->num_rows;
                ...
                ?>
                    <tr>
                        ...
                        <td><center><?php echo $fetch['occupied']?></center></td></td>
                    </tr>
                <?php
                    }
                    $conn->close();
