...
<button><a style = "text-decoration:none; color:#000;" href = "manage-words.php">Back</a></button>
<?php
    ...
    <div id="print">
            ...
            <center>
                <table>
                        <tr>
                            ...
                            <th style = "padding-right:90px;padding-left:90px;"><center>Bed Name</center></th>
                            <th style = "padding-right:40px;padding-left:40px;"><center>Word</center></th>
                            <th style = "padding-left:30px; padding-right:30px;"><center>Occupied</center></th>
                             <th style = "padding-left:60px; padding-right:60px;"><center>O. By</center></th>
                        </tr>
                <?php
        ...
        $cnt=$query->num_rows;
                    for($a = 1; $a <= $cnt; $a++){
                        ...
                        $qry=$conn->query("SELECT name  FROM bed_trans where bed='$fetch[b_id]'")or die (mysqli_error());
$rw = $qry->fetch_array();
                ?>
                    <tr>
                        <td><center><?php echo $fetch['b_id']?></center></td>
                        <td><center><?php echo $fetch['name']?></center></td>
                        <td><center><?php echo $fetch['word']?></center></td>
                        <td><center><?php echo $fetch['occupied']?></center></td>
                         <td><center><?php echo $rw['name']?></center></td>
                    </tr>
                <?php
                    }
                    $conn->close();
