...
<br />
    <div id="print">
        <div style = "margin:10px;">    <br />      
            ...
            <br />
             <center><b>VISITORS LIST</b></center>
            <br />
            <label>Date:
                <?php echo "<u>".
                       date("d-m-Y")."</u>";
            ...
            <center>
                <table>
                        <tr>
                            <th style = "padding-right:20px;padding-left:0px;"><center>ID.</center></th>
                            <th style = "padding-right:70px;padding-left:70px;"><center>Name</center></th>
                            <th style = "padding-right:50px;padding-left:50px;"><center>Email</center></th>
                            <th style = "padding-left:40px; padding-right:40px;"><center>Phone</center></th>
                            <th style = "padding-right:30px;padding-left:30px;"><center>ID NO</center></th>
                            <th style = "padding-right:50px;padding-left:50px;"><center>Address</center></th>
                        </tr>
                <?php
        ...
        $cnt=$query->num_rows;
                ...
                ?>
                    <tr>
                        ...
                        <td><center><?php echo $fetch['physical_location']?></center></td>
                    </tr>
                <?php
                    }
                    $conn->close();
