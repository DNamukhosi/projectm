            ...
            <center>
                <table>
                        <tr>
                            ...
                            <th style = "padding-right:50px;padding-left:50px;"><center>Capacity</center></th>
                            <th style = "padding-left:40px; padding-right:40px;"><center>Available</center></th>
                        </tr>
                <?php
        ...
        $cnt=$query->num_rows;
                ...
                ?>
                    <tr>
                        ...
                        <td><center><?php echo $fetch['available']?></center></td></td>
                    </tr>
                <?php
                    }
                    $conn->close();
