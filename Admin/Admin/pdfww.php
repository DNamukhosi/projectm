...
<?php
    ...
    $conn = new mysqli("localhost", "root", "", "matharihms") or die(mysqli_error());
...
<br />
    <div id="print">
            ...
            <center>
                <table>
                        <tr>
                            ...
                            <th style = "padding-right:30px;padding-left:30px;"><center>Capacity</center></th>
                            <th style = "padding-right:40px;padding-left:40px;"><center>Available</center></th>
                        </tr>
                <?php
        ...
        $cnt=$query->num_rows;
                ...
                ?>
                    <tr>
                        <td><center><?php echo $fetch['w_id']?></center></td>
                        <td><center><?php echo $fetch['name']?></center></td>
                        <td><center><?php echo $fetch['capacity']?></center></td>
                        <td><center><?php echo $fetch['available']?></center></td>
                    </tr>
                <?php
                    }
                    $conn->close();
