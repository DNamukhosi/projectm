...
$dno=$code.$ln;
 ...
 $writex =$conn->query("INSERT INTO p_visitor(`v_id`,`firstname`,`middlename`,`lastname`,`phone_no`,`idno`,`physical_location`,`gender`) VALUES ('$dno','$fname','$mname','$lname','$phone','$idno','$loc','$gender')") or die(mysqli_error());
    ...
    <div class="box box-primary">
      <div class="box-header with-border ">
        <i class="fa fa-user"></i> <h3 class="box-title">VISITORS</h3>
         ...
         <a href="pdfv.php"><span class="btn btn-success bg-green"><i class="fa fa-edit"></i> Print </span></a>
</div>
